...
if ((this.transform && (this.transform._localID !== this.transform._currentLocalID)) ||
  ...
  var resLib = {
    ...
    async loadGame() {
      ...
      let atlases = [
        ["./img/a0.{webp,png}.96d73ac1b9.json","./img/a1.{webp,png}.c3df4a5aa2.json","./img/a2.{webp,png}.028af0c3c8.json","./img/a3.{webp,png}.4177a0a432.json","./img/a4.{webp,png}.e570510774.json","./img/a5.{webp,png}.937a8961e6.json","./img/a6.{webp,png}.b74656e833.json","./img/a7.{webp,png}.e36cbcef15.json","./img/a8.{webp,png}.2b8436632f.json","./img/a9.{webp,png}.328e8b9562.json","./img/a10.{webp,png}.9bdfaaa0bb.json","./img/a11.{webp,png}.a960f9e904.json","./img/a12.{webp,png}.4c18d2f4de.json","./img/a13.{webp,png}.ac03917d5f.json","./img/a14.{webp,png}.086bd66d5c.json","./img/a15.{webp,png}.3db3a5c30b.json","./img/a16.{webp,png}.a77fc46f8b.json","./img/a17.{webp,png}.ea7a5c35f9.json","./img/a18.{webp,png}.433342ee28.json","./img/a19.{webp,png}.4d09c103dd.json","./img/a20.{webp,png}.8458eb8ac2.json","./img/a21.{webp,png}.1cd9626228.json","./img/a22.{webp,png}.00930c528e.json","./img/a23.{webp,png}.758385bf7c.json","./img/a24.{webp,png}.1790447fee.json","./img/a25.{webp,png}.9a369dee21.json","./img/a26.{webp,png}.cf61fea344.json"]
      ][0];
      let bitmapFonts = [
        []
      ][0];
...
{
this.move();
// A Trava do Pause: Se pausado, não faça absolutamente nada!
if (window.pausado) {
    return;
}

// O Cronômetro da chuva
this.timer -= 2;
...
if (this.timer <= 0) {
    ...
    // Sorteia se vai cair algo bom (50% de chance) ou ruim
    if (Math.random() > 0.5) {
    ...
    // Reinicia o relógio para a próxima gota
    this.timer = 150; 
}
...
{
// Define a transparência (0 é invisível, 1 é sólido)
this.alpha = 0.7; // 0.7 dá aquele tom escurecido chique
...
// 1. Limpeza de memória e definições
window.jogoAcabou = false;
window.vidas = 3;
window.ferramenta = 'nenhuma';

// 2. Chama a ÚNICA sala que gerencia todos os popups
rooms.append('SalaTutoriais', {
    isUi: true
});
}
...
// Descobre o centro exato da tela dinamicamente
let centroX = camera.width / 2;

// Coloca no meio, mas sobe 40 pixels para o "Centro Ótico" (fica muito mais elegante!)
let centroY = (camera.height / 2) - 40; 

// Invoca a primeira imagem exatamente nessa posição calculada
templates.copy('PopupAjuda', centroX, centroY);
}
...
// 1. Define as definições globais da partida
window.jogoAcabou = false;
window.vidas = 3;
window.ferramenta = 'nenhuma';

// 2. Chama a sala mestre que cuida de tudo sozinha!
// Pare aqui! Não precisa de mais nada abaixo desta linha.
rooms.append('SalaTutoriais', { isUi: true });
}
...
rooms.templates['vitoria-total'] = {
    ...
    height: 720,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":544,"y":525,"opacity":1,"tint":16777215,"scale":{"x":0.57,"y":0.57},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoCreditosVitoria"},{"x":688,"y":592,"opacity":0,"tint":16777215,"scale":{"x":1.07563025,"y":0.7},"rotation":0,"exts":{},"customProperties":{},"template":"BtnSaidaTotal"},{"x":208,"y":592,"opacity":0,"tint":16777215,"scale":{"x":1.15490196,"y":0.8},"rotation":0,"exts":{},"customProperties":{},"template":"BtnAbreMapa"}]'),
...
rooms.templates['SalaMapa'] = {
    ...
    height: 720,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":0,"y":0,"opacity":1,"tint":16777215,"scale":{"x":0.765,"y":0.765},"rotation":0,"exts":{},"customProperties":{},"template":"FundoEscuro"},{"x":640,"y":384,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"mapa-niveis"},{"x":520,"y":584,"opacity":1,"tint":16777215,"scale":{"x":0.7,"y":0.7},"rotation":0,"exts":{},"customProperties":{},"template":"BtnFecharMapa"},{"x":528,"y":344,"opacity":0,"tint":16777215,"scale":{"x":0.6,"y":0.6},"rotation":0,"exts":{},"customProperties":{},"template":"BtnIrNivel2"},{"x":256,"y":344,"opacity":0,"tint":16777215,"scale":{"x":0.6,"y":0.6},"rotation":0,"exts":{},"customProperties":{},"template":"BtnIrNivel1"},{"x":824,"y":344,"opacity":0,"tint":16777215,"scale":{"x":0.6,"y":0.6},"rotation":0,"exts":{},"customProperties":{},"template":"BtnIrNivel3"}]'),
    bgs: JSON.parse('[]'),
    tiles: JSON.parse('[]'),
    backgroundColor: '#000000',
