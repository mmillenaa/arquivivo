...
{
// 1. Define as definições globais da partida (A faxina na memória!)
window.jogoAcabou = false;
window.vidas = 3;
window.ferramenta = 'nenhuma';

// 2. Abre o popup de ajuda forçadamente e pausa o jogo
window.menuAjudaAberto = true;
window.pausado = true;
rooms.append('PopupAjuda', {
    isUi: true
