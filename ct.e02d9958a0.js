...
if ((this.transform && (this.transform._localID !== this.transform._currentLocalID)) ||
  ...
  var resLib = {
    ...
    async loadGame() {
      ...
      let atlases = [
        ["./img/a0.{webp,png}.96d73ac1b9.json","./img/a1.{webp,png}.c3df4a5aa2.json","./img/a2.{webp,png}.028af0c3c8.json","./img/a3.{webp,png}.4177a0a432.json","./img/a4.{webp,png}.e570510774.json","./img/a5.{webp,png}.937a8961e6.json","./img/a6.{webp,png}.a5957054f8.json","./img/a7.{webp,png}.7cb150df89.json","./img/a8.{webp,png}.4ff36c9861.json","./img/a9.{webp,png}.41513a5614.json","./img/a10.{webp,png}.448470c5ec.json","./img/a11.{webp,png}.0b78a95538.json","./img/a12.{webp,png}.2bedec8e10.json","./img/a13.{webp,png}.5ddfea5341.json","./img/a14.{webp,png}.086bd66d5c.json","./img/a15.{webp,png}.80111e6859.json","./img/a16.{webp,png}.a77fc46f8b.json","./img/a17.{webp,png}.ea7a5c35f9.json","./img/a18.{webp,png}.1eeb550818.json","./img/a19.{webp,png}.3377c66205.json","./img/a20.{webp,png}.e7e28932bb.json","./img/a21.{webp,png}.5521801711.json","./img/a22.{webp,png}.ab97f36c36.json","./img/a23.{webp,png}.1a0c65227b.json","./img/a24.{webp,png}.3f106721fb.json","./img/a25.{webp,png}.447fb8c4b1.json","./img/a26.{webp,png}.3ec5896dfd.json","./img/a27.{webp,png}.5a03505392.json"]
      ][0];
      let bitmapFonts = [
        []
      ][0];
...
{
this.move();
// Aqui removemos o "if (window.pausado) return" para que o botão
// continue calculando a transparência mesmo se o jogo estiver pausado!
...
// SISTEMA DE ESMAECIMENTO SUAVE
// ==========================================
// Checa se há qualquer objeto com colisão embaixo do botão
let objetoEmbaixo = place.occupied(this, this.x, this.y);

if (objetoEmbaixo) {
    this.alpha += (0.5 - this.alpha) * 0.1; // Vai para 50% suavemente
} else {
    this.alpha += (1.0 - this.alpha) * 0.1; // Volta para 100% suavemente
}
}
...
templates.templates["PopupAjuda1"] = {
    name: "PopupAjuda1",
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    visible: true,
...
// ==========================================
// 1. SENSOR DE TOQUE (Com Zona Morta Inteligente)
// ==========================================
if (actions.Mover.down && window.sobreMenu !== true) {
    let distX = pointer.x - this.x;
    let distY = pointer.y - this.y;
    // Calcula a distância real do mouse até o boneco
    let distTotal = Math.hypot(distX, distY);

    // Só começa a andar se o mouse estiver a mais de 20 pixels de distância (evita tremedeira)
    if (distTotal > 20) { 
    ...
    // Corrige a velocidade na diagonal para não correr mais rápido
    if (movX !== 0 && movY !== 0) {
        movX *= 0.707;
        movY *= 0.707;
    }
...
if (window.ferramenta === 'extintor') {
    this.alpha = 1; 
    // Fica com 25% do tamanho quando selecionado (destaque)
    this.scale.set(0.22); 
} else {
    this.alpha = 0.5; 
    // Fica com 20% do tamanho quando não selecionado
    this.scale.set(0.2); 
}
...
{
this.move();
// Unificamos o nome para 'arquivista' sem "C" no final
if (window.ferramenta === 'arquivista') {
    this.alpha = 1; 
    this.scale.set(0.085); 
} else {
    this.alpha = 0.5; 
    this.scale.set(0.081); 
}
...
if (window.vidas === 3) novaTextura = '100-barra-nivel2';
    ...
    // --- GATILHO DO GPS PARA A TELA DE DERROTA ---
    // A trava '!window.jogoAcabou' impede que o ct.js trave abrindo a sala infinitamente
    if (!window.jogoAcabou) {
        window.jogoAcabou = true;
        window.nivelAtual = 'Nivel2'; // Salva no GPS onde o jogador falhou
        rooms.switch('derrota'); // Manda para a tela de game over
    }
}
...
// ==========================================
// 1. SENSOR DE TOQUE (Modo 8 Direções)
// ==========================================
if (actions.Mover.down && window.sobreMenu !== true) {
    let distX = pointer.x - this.x;
    let distY = pointer.y - this.y;
...
if (this.timerSurgimento >= this.intervalo && livrosNoChao < limiteDinamico) {
    ...
    // Tenta achar um lugar livre de paredes invisíveis
    while (tentativa < 20 && !encontrouLugar) {
        let px = Math.random() * rooms.current.width;
        let py = Math.random() * rooms.current.height;

        let doc = templates.copy('Documento', px, py);
        doc.scale.set(0.15); // Já garante o tamanho certo
        ...
        if (place.free(doc, px, py, 'Obstaculo')) {
            ...
            // Se caiu dentro do bloco rosa da parede, a gente destrói ele antes de aparecer
            doc.kill = true; 
        }
...
// 2. CONTROLE DE OPACIDADE COM TRANSIÇÃO SUAVE
let alvoAlpha = window.heroiParado ? 0.4 : 1.0;
...
this.cursor = 'pointer'; // O mouse vira uma mãozinha
}
...
this.cursor = 'pointer'; // Vira a mãozinha
}
...
rooms.templates['Nivel1'] = {
    ...
    height: 720,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":776.56430984,"y":119.2478846,"opacity":1,"tint":16777215,"scale":{"x":0.25,"y":0.25},"rotation":0.0009822185445255923,"exts":{},"customProperties":{},"template":"BotaoPausa"},{"x":1159.13409408,"y":120.0630067,"opacity":1,"tint":16777215,"scale":{"x":0.3,"y":0.3},"rotation":0.0009822185445255923,"exts":{},"customProperties":{},"template":"BotaoAjuda"},{"x":640.06422772,"y":319.99464248,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0.0009822185445255923,"exts":{},"customProperties":{},"template":"Gerador"},{"x":1119.78897503,"y":600.46597224,"opacity":1,"tint":16777215,"scale":{"x":0.18,"y":0.18},"rotation":0.0009822185445255923,"exts":{},"customProperties":{},"template":"BotaoSair"},{"x":654.58744196,"y":645.43033218,"opacity":1,"tint":16777215,"scale":{"x":0.08,"y":0.08},"rotation":0.0028925939002123376,"exts":{},"customProperties":{},"template":"Hero"},{"x":824.29987138,"y":80.17548644,"opacity":1,"tint":16777215,"scale":{"x":0.4,"y":0.4},"rotation":0.0009822185445255923,"exts":{},"customProperties":{},"template":"BarraProgresso"},{"x":1216,"y":128,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"GeradorVidas"}]'),
...
{
// 1. Define as definições globais
window.vidas = 3;
window.jogoAcabou = false;

// 2. Abre o popup de ajuda forçadamente
window.menuAjudaAberto = true;
window.pausado = true;
rooms.append('PopupAjuda', {
    isUi: true
...
rooms.templates['TelaDisclaimer'] = {
    ...
    bgs: JSON.parse('[{"texture":"disclaimer-novo","depth":0,"exts":{"movementX":0,"movementY":0,"parallaxX":1,"parallaxY":1,"repeat":"no-repeat","scaleX":1,"scaleY":1,"shiftX":0,"shiftY":0}}]'),
    tiles: JSON.parse('[]'),
    backgroundColor: '#000000',
...
rooms.templates['vitoria'] = {
    ...
    height: 720,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":639.68780488,"y":641.08973769,"opacity":0,"tint":16777215,"scale":{"x":0.05203252,"y":0.0754717},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoContinuar"},{"x":568,"y":568,"opacity":1,"tint":16777215,"scale":{"x":0.4,"y":0.4},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoAvancar"}]'),
...
rooms.templates['PopupAjuda'] = {
    name: 'PopupAjuda',
    width: 1280,
    height: 720,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":0,"y":0,"opacity":0,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"FundoEscuro"},{"x":656,"y":368,"opacity":1,"tint":16777215,"scale":{"x":0.24,"y":0.2150056},"rotation":0,"exts":{},"customProperties":{},"template":"PopupAjuda"},{"x":608,"y":473,"opacity":0,"tint":16777215,"scale":{"x":0.17852162,"y":0.2},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoOkPop"}]'),
    bgs: JSON.parse('[]'),
    tiles: JSON.parse('[]'),
...
rooms.templates['PopupObjetivo'] = {
    name: 'PopupObjetivo',
    width: 1280,
    height: 720,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":0,"y":0,"opacity":0,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"FundoEscuro"},{"x":512,"y":320,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ConteudoObjetivo"},{"x":680,"y":192,"opacity":0,"tint":16777215,"scale":{"x":0.33160622,"y":0.28699552},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoFecharObjetivo"}]'),
    bgs: JSON.parse('[]'),
    tiles: JSON.parse('[]'),
    backgroundColor: '#000000',
...
rooms.templates['Nivel2'] = {
    ...
    height: 720,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":130.83185862,"y":575.86389826,"opacity":1,"tint":16777215,"scale":{"x":0.56637168,"y":0.46332046},"rotation":0,"exts":{},"customProperties":{},"template":"Parede"},{"x":407.61061925,"y":591.59845581,"opacity":1,"tint":16777215,"scale":{"x":0.47787611,"y":0.46332046},"rotation":0,"exts":{},"customProperties":{},"template":"Parede"},{"x":719.61061925,"y":591.59845581,"opacity":1,"tint":16777215,"scale":{"x":0.47787611,"y":0.46332046},"rotation":0,"exts":{},"customProperties":{},"template":"Parede"},{"x":991.61061914,"y":567.59845593,"opacity":1,"tint":16777215,"scale":{"x":0.47787611,"y":0.46332046},"rotation":0,"exts":{},"customProperties":{},"template":"Parede"},{"x":0,"y":-160,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":-128,"y":-160,"opacity":1,"tint":16777215,"scale":{"x":3.65217391,"y":1.7254901999999999},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":640,"y":-160,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":896,"y":-160,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":1208,"y":0,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":1191.62128369,"y":-230.92696729,"opacity":1,"tint":16777215,"scale":{"x":1.95291628,"y":2.05167466},"rotation":0.9076503902092622,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":1208,"y":384,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":1208,"y":576,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":960,"y":672,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":768,"y":672,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":576,"y":672,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":384,"y":672,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":128,"y":672,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":-64,"y":672,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":-312,"y":0,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":-312,"y":192,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":-324.08962755,"y":407.31510807,"opacity":1,"tint":16777215,"scale":{"x":2.28781335,"y":1.80978459},"rotation":-0.9224598508905815,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":-312,"y":576,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"ParedeInvisivel"},{"x":1112,"y":600,"opacity":1,"tint":16777215,"scale":{"x":0.18,"y":0.18},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoSair"},{"x":333.02439024,"y":372.19105691,"opacity":1,"tint":16777215,"scale":{"x":0.56,"y":0.49},"rotation":0,"exts":{},"customProperties":{},"template":"Armario2"},{"x":906.97560976,"y":467.98780488,"opacity":1,"tint":16777215,"scale":{"x":0.53658537,"y":0.49430894},"rotation":0,"exts":{},"customProperties":{},"template":"Armario1"},{"x":768,"y":320,"opacity":1,"tint":16777215,"scale":{"x":0.53658537,"y":0.49430894},"rotation":0,"exts":{},"customProperties":{},"template":"Armario3"},{"x":960,"y":352,"opacity":1,"tint":16777215,"scale":{"x":0.53658537,"y":0.46341463},"rotation":0,"exts":{},"customProperties":{},"template":"Armario3"},{"x":512,"y":512,"opacity":1,"tint":16777215,"scale":{"x":0.53658537,"y":0.49430894},"rotation":0,"exts":{},"customProperties":{},"template":"Armario5"},{"x":498.97560976,"y":331.98780488,"opacity":1,"tint":16777215,"scale":{"x":0.53658537,"y":0.49430894},"rotation":0,"exts":{},"customProperties":{},"template":"Armario1"},{"x":728,"y":464,"opacity":1,"tint":16777215,"scale":{"x":0.53658537,"y":0.49430894},"rotation":0,"exts":{},"customProperties":{},"template":"Armario5"},{"x":1095,"y":152,"opacity":1,"tint":16777215,"scale":{"x":0.2,"y":0.2},"rotation":0,"exts":{},"customProperties":{},"template":"BtnExtintor"},{"x":1100,"y":312,"opacity":1,"tint":16777215,"scale":{"x":0.2,"y":0.2},"rotation":0,"exts":{},"customProperties":{},"template":"BtnRodo"},{"x":1096,"y":232,"opacity":1,"tint":16777215,"scale":{"x":0.2,"y":0.2},"rotation":0,"exts":{},"customProperties":{},"template":"BtnFerramenta"},{"x":1128.3028391,"y":112.07339476,"opacity":1,"tint":16777215,"scale":{"x":0.18,"y":0.18},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoPausa"},{"x":1072,"y":384,"opacity":1,"tint":16777215,"scale":{"x":0.085,"y":0.087},"rotation":0,"exts":{},"customProperties":{},"template":"BtnArquivista"},{"x":1216,"y":512,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"GeradorGeral"},{"x":272,"y":520,"opacity":1,"tint":16777215,"scale":{"x":0.53658537,"y":0.49430894},"rotation":0,"exts":{},"customProperties":{},"template":"Armario3"},{"x":1216,"y":128,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"InterfaceVidas"},{"x":564.98281472,"y":358.34223798,"opacity":1,"tint":16777215,"scale":{"x":0.28368507,"y":0.3192377},"rotation":0,"exts":{},"customProperties":{},"template":"Heroi"},{"x":712,"y":85,"opacity":1,"tint":16777215,"scale":{"x":0.2,"y":0.2},"rotation":0,"exts":{},"customProperties":{},"template":"BarraIntegridade"},{"x":1080,"y":620,"opacity":1,"tint":16777215,"scale":{"x":0.2,"y":0.2},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoAjuda"}]'),
...
{
// 1. Começa o jogo com as mãos vazias
...
{
// 1. Abre o popup de ajuda forçadamente
window.menuAjudaAberto = true;
window.pausado = true;
rooms.append('PopupAjuda', {
    isUi: true
...
rooms.templates['vitoria-total'] = {
    ...
    height: 720,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":560,"y":533,"opacity":1,"tint":16777215,"scale":{"x":0.5,"y":0.5},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoCreditosVitoria"},{"x":200,"y":600,"opacity":0.44,"tint":16777215,"scale":{"x":0.17333333,"y":0.035},"rotation":0,"exts":{},"customProperties":{},"template":"BotaoJogarNovamente"}]'),
